...
export default async function LoginPage({
  ...
  return (
    <div className="min-h-screen gradient-bg-radial flex flex-col items-center justify-center px-6">
      {/* Logo */}
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-spotify">Deep Digs</h1>
      </div>
      ...
      {error && (
        <div className="glass border-danger/30 rounded-xl p-4 mb-6 text-sm text-danger max-w-sm w-full text-center">
